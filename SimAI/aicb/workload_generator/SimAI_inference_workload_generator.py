...
class SimAIWorkload():
    ...
    def get_comm_size(self):#传输数据量计算
        ...
        #打印计算细节
        print(f"tp_comm_size: {tp_comm_size} = 2 * {m} * {self.args.hidden_size}")
        print(f"ep_combine_size: {ep_combine_size} = tp_comm_size * {self.topk} // {self.tp}")
        print(f"ep_dispatch_size: {ep_dispatch_size} = ep_combine_size")
