...
int main(int argc, char **argv)
{
    ...
    int fattree_node = find_nonum(no_of_nodes);// find min k for no_of_nodes
    FatTreeTopology *top = new FatTreeTopology(fattree_node, queuesize, nullptr /*&logfile*/, &eventlist, ff, ECN);
