...
enum TaskIDs {
  ...
  // Taskgraph generate task
  CUSTOM_TASKGRAPH_TASK_ID,
  CUSTOM_TASKGRAPH_TASK_ID_1,
  CUSTOM_TASKGRAPH_TASK_ID_2,
...
public:
  ...
  void generate_taskgraph(PCG::Graph &best_graph,
                          std::unordered_map<PCG::Node, MachineView> &optimal_views,
                          CompMode comp_mode);
  
  void compile_taskgraph(CompMode comp_mode = COMP_MODE_TRAINING);
