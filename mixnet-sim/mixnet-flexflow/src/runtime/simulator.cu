...
__host__
void Simulator::simulation_task(Legion::Task const *task,
...
__host__
void LogicalTaskgraphBasedSimulator::simulation_task(Legion::Task const *task,
                                std::vector<Legion::PhysicalRegion> const &regions,
                                Legion::Context ctx, 
                                Legion::Runtime *runtime) {
                                  // TODO
...
__host__
void TaskgraphSimulator::simulation_task(Legion::Task const *task,
                                std::vector<Legion::PhysicalRegion> const &regions,
                                Legion::Context ctx, 
                                Legion::Runtime *runtime) {
                                  // TODO
