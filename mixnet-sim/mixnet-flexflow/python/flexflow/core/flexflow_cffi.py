...
class FFModel(object):
  ...
  def multihead_attention(self, query, key, value, 
                          ...
                          kernel_initializer=None, name=None, is_moe=True, batch_size=0):
    ...
    :param is_moe: check if attention used in MoE. Default is False.
    :type name: bool
    
    :param batch_size: check if attention used in MoE. Default is 0.
    :type name: int
    ...
    c_name = get_c_name(name)                 
    kernel_init_handle = self.__get_initializer_handle(kernel_initializer)
    handle = ffc.flexflow_model_add_multihead_attention(self.handle, query.handle, key.handle, value.handle, embed_dim, num_heads, kdim, vdim, dropout, bias, add_bias_kv, add_zero_attn, kernel_init_handle, c_name, is_moe, batch_size)
